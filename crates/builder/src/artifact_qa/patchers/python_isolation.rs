...
export PYTHONPATH="/opt/pm/live/python/{package_name}/lib/{python_version}/site-packages:${{PYTHONPATH}}"
exec /opt/pm/live/bin/{python_version} "/opt/pm/live/python/{package_name}/bin/{executable_name}" "$@"
"#
        );
