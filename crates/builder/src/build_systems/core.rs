...
mod tests {
    use super::*;
    use crate::BuildContext as RootBuildContext;
    ...
    fn test_build_context_creation() {
        ...
        assert_eq!(ctx.source_dir, temp.path());
        assert_eq!(ctx.prefix, PathBuf::from("/opt/pm/live"));
        assert!(ctx.jobs >= 1);
    }
    ...
    fn test_platform_triple() {
        ...
        assert_eq!(linux_platform.triple(), "x86_64-unknown-linux-gnu");
    }
