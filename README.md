...
**This project is in the early stages of development.** It is not yet recommended for production use. The API, package format, and internal architecture are still subject to change. There is no public package repository yet. We welcome contributors who are excited about building the future of package management on macOS.
...
# ╞══════════════════════════════════════╪═════════╪═══════════╪══════════════════╪══════════╡
# │ 48b6f85f-78bb-4dc5-9487-a8a60e97423b ┆ *       ┆ install   ┆ 2025-06-13 16:12 ┆ 4        │
# ├╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┼╌╌╌╌╌╌╌╌╌┼╌╌╌╌╌╌╌╌╌╌╌┼╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┼╌╌╌╌╌╌╌╌╌╌┤
# │ a7be49ca-a976-4f75-8b30-033d0d27e722 ┆         ┆ install   ┆ 2025-06-13 16:11 ┆ 3        │
# └──────────────────────────────────────┴─────────┴───────────┴──────────────────┴──────────┘
...
- [moss & boulder](https://github.com/AerynOS/os-tools) from Serpent OS/AerynOS - Inspiration for atomic updates, content-addressed storage, and stateful package management
